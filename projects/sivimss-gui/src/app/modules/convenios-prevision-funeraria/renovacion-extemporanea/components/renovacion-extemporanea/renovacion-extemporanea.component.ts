 ...
 abrirModalHabilitarRenovacion(): void {
   this.creacionRef = this.dialogService.open(HabilitarRenovacionComponent, {
    ...
    this.creacionRef.onClose.subscribe((estatus:boolean) => {
      if(estatus){
        this.alertaService.mostrar(TipoAlerta.Exito, 'Renobacion habilitada correctamente');
      }
    })
}

abrirPanel(event:MouseEvent,articuloSeleccionado:ConveniosPrevision):void{
