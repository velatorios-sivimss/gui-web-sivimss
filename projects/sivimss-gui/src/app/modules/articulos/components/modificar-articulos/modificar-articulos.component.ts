...
export class ModificarArticulosComponent implements OnInit {
  ...
  confirmarModificarArticulo(): void{
    ...
    this.articulos = {
      id: this.modificarArticuloForm.get("id")?.value,
      categoria: this.modificarArticuloForm.get("categoria")?.value,
      tipoDeArticulo:this.modificarArticuloForm.get("tipoDeArticulo")?.value,
      tipoDeMaterial: this.modificarArticuloForm.get("tipoDeMaterial")?.value,
      tamanio: this.modificarArticuloForm.get("tamanio")?.value,
      clasificacionDeProducto: this.modificarArticuloForm.get("clasificacionDeProducto")?.value,
      modeloDeArticulo: this.modificarArticuloForm.get("modeloDeArticulo")?.value,
      descripcionDeProducto: this.modificarArticuloForm.get("descripcionDeProducto")?.value,
      ...
      cuentaClave:this.modificarArticuloForm.get("cuentaClave")?.value,
      cuentaContable:this.modificarArticuloForm.get("cuentaContable")?.value,
      partidaPresupuestal:this.modificarArticuloForm.get("partidaPresupuestal")?.value,
    };
